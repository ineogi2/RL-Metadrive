...
def train(main_args):
    ...
    for epoch in range(epochs):
        ...
        log_data = {"score":score, "success_rate":success, "cv":cvs, "value loss":v_loss, "cost value loss":cost_v_loss, "objective":objective, "cost surrogate":cost_surrogate, "kl":kl, "entropy":entropy}
        print(log_data)
